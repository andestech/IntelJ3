...
/* -------------------------------------------------------------------------------- */
// TODO: modify this function to target-specific function
void Flash_UnLock(unsigned int addr_start)
{
...
/* -------------------------------------------------------------------------------- */
// TODO: modify this function to target-specific function
void Flash_Lock(unsigned int addr_start)
{
	unsigned int base = guiCtrlBase;
	base += addr_start;
...
/* -------------------------------------------------------------------------------- */
// TODO: modify this function to target-specific function
void Flash_ChipErase(unsigned int addr_start)
{
	unsigned int base = guiCtrlBase;
	base += addr_start;
...
int IntelJ3_erase(unsigned int FlashAddr, unsigned int DataSize)
{
	...
	for (i = 0; i < EraseBlkCnt; i++) {
		...
		fflush(pLogFile);
		Flash_ChipErase(EraseAddrStart);
